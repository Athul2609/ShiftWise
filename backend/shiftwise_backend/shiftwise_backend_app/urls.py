...
urlpatterns = [
    ...
    path('dependents/bulk-create/', DependentsCreateView.as_view(), name='dependents-bulk-create'),
    path('teams/create/', TeamCreateView.as_view(), name='team-create'),
    path('teams/', TeamListView.as_view(), name='team-list'),
    path('teams/<int:roster_id>/', TeamsByRosterView.as_view(), name='teams-by-roster'),
    path('teams/delete/<int:roster_id>/', DeleteTeamsByRosterView.as_view(), name='delete-teams-by-roster'),
    ...
    path('roster/<int:roster_id>/', RosterByRosterIDView.as_view(), name='rosters-by-roster-id'),
