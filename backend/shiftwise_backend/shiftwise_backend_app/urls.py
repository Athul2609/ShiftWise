...
urlpatterns = [
    ...
    path('off-requests/<int:doctor_id>/', OffRequestByDoctorView.as_view(), name='off-requests-by-doctor'),
    path('off-requests/<int:doctor_id>/<int:date>/', OffRequestDeleteView.as_view(), name='offrequest-delete'),
    path('off-requests/range/', OffRequestsByDateRangeView.as_view(), name='off-requests-range'),
