"""
Django settings for shiftwise_backend project.
...
SECRET_KEY = 'django-insecure-^5&!n$s&1+fx+)xiua75e#v&afhu1n+&9!zt$d(7sh^cq8*cos'
...
from decouple import config # Email configuration
# default backend
